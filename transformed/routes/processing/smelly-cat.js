...
const sharp_1 = __importDefault(require('sharp')); // Image processing package, uses libvibs
const smellyCat = (0, express_1.default)();
// endpoint level middleware, Request, Response
smellyCat.get('/', (request, respon) => {
  // this was hard to find, I cried my eyes for it
  ...
  const way =
    ...
    `\\Assets\\thumb\\smelly-cat-thumb${width}x${height}.jpg`;
...
// exporting smellyCat to router
exports.default = smellyCat;
